...
register_sidebar(
		array(
			'name'          => "region haut gauche",
			'id'            => "region_hg",
			'description'   => "region du haut servant principalement pour le widget logo",
			'before_widget' => '<aside id="%1$s" class="widget %2$s">',
			'after_widget'  => '</aside>',
			'before_title'  => '<h3 class="widget-title">',
			'after_title'   => '</h3>',
	...
	register_sidebar(
		array(
			'name'          => "region haut droite",
			'id'            => "region_hd",
			'description'   => "region du haut servant principalement pour autre chose",
			'before_widget' => '<aside id="%1$s" class="widget %2$s">',
			'after_widget'  => '</aside>',
			'before_title'  => '<h3 class="widget-title">',
			'after_title'   => '</h3>',
	...
	register_sidebar(
		array(
			'name'          => "region du milieu gauche",
			'id'            => "region_milieu_gauche",
			'description'   => "region du milieu gauche n'apparaissant que dans le modele de page trois colonnes",
			'before_widget' => '<aside id="%1$s" class="widget %2$s">',
			'after_widget'  => '</aside>',
			'before_title'  => '<h3 class="widget-title">',
			'after_title'   => '</h3>',
